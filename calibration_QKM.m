...
q_vec_0 = [ 0 0 300;                         
           ...
           length_of_links(3) 0 length_of_links(1)+length_of_links(2);
           length_of_links(3) 0 length_of_links(1)+length_of_links(2);
           length_of_links(3) 0 length_of_links(1)+length_of_links(2)]';
...
SMR_initial_file_name = 'gst0.txt';
...
data_file_name = 'POESE.txt';
angle_file_name = 'real_angles.txt';
...
while j<20
    ...
    if norm(dp) < 0.0009                                                   % quit the for loop if deviation is less than 1e-5
        break;
    end
    %% plot
    clf;                                                                    % clear plot
...
angle_file_name = 'test_angles.txt';
